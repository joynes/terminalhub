...
import se.joynes.terminalhub.data.db.MIGRATION_1_2
import se.joynes.terminalhub.data.db.MIGRATION_2_3
import se.joynes.terminalhub.data.db.MIGRATION_3_4
import se.joynes.terminalhub.data.db.MIGRATION_4_5
import se.joynes.terminalhub.data.db.MIGRATION_5_6
import se.joynes.terminalhub.data.db.MIGRATION_6_7
